...
# DATA TYPES
def data_Types():
    print(f"\n{bold_start}Data Types:{italic_start}")

#Int
def Int():
    print(f"\n{bold_start}Int Type:{italic_start}")
    print("Defination: An integer is a whole number (not a fration) that can be positive,negative, or zero. Integers are a common data type in computer programming. They are used to store whole numbers. For example, the number 10 is an integer.")
    x: int = 5
    result = x + 5
    ...
    def String():
        ...
        print("Defination: A string is a sequence of characters enclosed in quotation marks. In Python, a string can be a sequenceofany character, include, leteer, number, special characters, and whitespace. strins are used to store text data in a program. For Example, the string 'Hello, World!' is a string.\n ")
        time.sleep(1)
